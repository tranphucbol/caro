...
class GameUserInfo extends React.Component {
  render() {
    return (
      <div className={`game-user-info d-flex ${this.props.right ? 'flex-row-reverse' : ''}`}>
        ...
        <div className={`d-flex justify-content-center ${this.props.right ? 'align-items-end' : ''} flex-column mx-2`}>
